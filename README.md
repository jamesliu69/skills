...
Two ways in, two philosophies. **skills.sh** copies editable skill files into your project, while the **Claude Code plugin** installs the whole set as a managed bundle. Pick one: installing both leaves you with every skill twice.
